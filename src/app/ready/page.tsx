...
export default function ReadyPage() {
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: "#1A0808" }}>
        ...
        <div className="absolute right-0 top-0 bottom-0 w-1/3 pointer-events-none overflow-hidden opacity-[0.06]">
          <div
            ...
            style={{
              backgroundImage: "repeating-conic-gradient(#C0392B 0% 25%, transparent 0% 50%)",
        ...
        <div
          ...
          style={{ background: "radial-gradient(ellipse 50% 60% at 20% 50%, rgba(139,32,32,0.18) 0%, transparent 70%)" }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-28 pb-20 w-full">
          <div className="max-w-3xl">
            ...
            >
              Uw voertuig.
              <br />
              <span style={{ color: "#E05252" }}>Altijd klaar.</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              ...
              >
                <div className="h-1 w-full" style={{ background: "#C0392B" }} />
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {service.tags.map((tag) => (
                      <span
                        ...
                        style={{ background: "#C0392B14", color: "#C0392B", fontFamily: "var(--font-body)" }}
                      >
                        {tag}
                      </span>
                    ))}
                  </div>
                  <div className="inline-flex items-center gap-1.5 text-sm font-bold" style={{ color: "#C0392B", fontFamily: "var(--font-body)" }}>
                    Meer informatie
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {productCategories.map((cat) => (
              <div
                key={cat.name}
                className="group bg-[#F7F6F2] hover:bg-[#C0392B] rounded-xl p-5 transition-all duration-200 cursor-default"
              >
      ...
      {/* ─── Voertuigtypes ────────────────────────────────── */}
      <section className="py-24" style={{ background: "#1A0808" }}>
        <div className="max-w-7xl mx-auto px-6">
